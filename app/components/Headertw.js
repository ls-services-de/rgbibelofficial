...
const Headertw = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 bg-card p-4 flex items-center justify-between z-50">
      ...
      <img src="/twlogo.png" alt="Logo" className="h-10 w-auto ml-5" />
      </div>
      ...
      <div className="hidden md:flex flex-1 justify-center">
        <div className="flex space-x-8">
          ...
          <Link href="/triebwerk" className="text-white hover:text-dimWhite font-poppins">Triebwerk</Link>
          <a href="#vision" className="text-white hover:text-dimWhite font-poppins">Über die Partnerschaft</a>
          <a href="#vorteile" className="text-white hover:text-dimWhite font-poppins">Vorteile </a>
          <a href="#kollektion" className="text-white hover:text-dimWhite font-poppins">Kollektion </a>
        </div>
      </div>
      ...
      <div className="hidden md:flex items-center relative">
        ...
        <div className="ml-2 mr-4 bg-[#FFD100] rounded-full w-5 h-5 flex items-center justify-center text-white text-xs font-semibold">
          {totalItems}
        </div>
        ...
        {isSignedIn ? (
          ...
          <Link href="/dashboard"><p className='ml-5 text-[#FFD100]'>Zum Dashboard</p></Link>
          </>
        ) : (
      ...
      {/* Dropdown Menu */}
      {isOpen && (
        <div className="absolute top-16 left-0 right-0 bg-card p-4 flex flex-col items-center space-y-4 md:hidden">
          {/* Links */}
          <Link href="/" className="text-white hover:text-dimWhite font-poppins">Start</Link>
          <Link href="/products" className="text-white hover:text-dimWhite font-poppins">Shop</Link>
          <Link href="/triebwerk" className="text-white hover:text-dimWhite font-poppins">Triebwerk</Link>
