...
const ProductReview = () => {
  ...
  const handleTrustpilotReview = () => {
    // Replace with your actual Trustpilot review URL
    window.open("https://de.trustpilot.com/review/rgbibelofficial.com", "_blank")
  }
    ...
    <>
      ...
      <div className="max-w-md mx-auto mt-[90px] p-6 bg-card rounded-lg shadow-xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label htmlFor="pcNumber" className="block text-sm font-medium text-dimWhite">
              PC-Nummer
            </label>
            <input
              id="pcNumber"
          ...
          {customerName && <div className="text-sm text-gray-600">Kundenname: {customerName}</div>}
          <div>
            ...
            <div className="flex items-center mt-1">
              {[1, 2, 3, 4, 5].map((star) => (
                <button
                  ...
                  className={`text-2xl focus:outline-none ${star <= rating ? "text-primary" : "text-gray-300"}`}
                >
                  ★
                </button>
              ))}
          ...
          <div>
            <label htmlFor="review" className="block text-sm font-medium text-dimWhite">
              Ihre Bewertung
            </label>
            <textarea
              id="review"
        ...
        <div className="mt-4 text-center">
          <p className="text-sm text-dimWhite mb-2">Oder bewerten Sie uns auf:</p>
          <button
            onClick={handleTrustpilotReview}
            className="inline-flex items-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-primary hover:bg-primary focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white"
          >
            <span className="mr-2">Auf Trustpilot bewerten</span>
