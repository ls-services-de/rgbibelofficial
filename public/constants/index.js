...
export const images = [
  { src: "/assets/slider1.png", alt: 'Low Budget', title: 'Low Budget', caption: 'Maximale Preis-Leistung' },
  { src: "/assets/slider2.png", alt: 'PROFESSIONAL', title: 'PROFESSIONAL', caption: 'Lässt die Konkurrenz alt aussehen!' },
  { src: "/assets/slider3.png", alt: 'MID BUDGET', title: 'MID BUDGET', caption: 'Eleganz trifft auf Leistung' },
  { src: "/assets/slider4.png", alt: 'High Budget', title: 'High Budget', caption: 'Extrem ist nicht genug.' },
  { src: "/assets/slider5.png", alt: 'High-END', title: 'High END', caption: 'Für alle die, die sich trauen.' },
...
export const promises = [
  {
    icon: "/assets/versprechen1.png",
    title: 'Konfigurator',
    description: 'Gestalte deinen individuellen PC mit unserem Konfigurator.',
  },
  {
...
export const vorteile = [
  {
    ...
    title: 'Gratis Booster-Pack',
    description: 'Sichere dir jetzt deinen neuen Gaming-PC und erhalte ein Gratis AIMBOOST-Probierset von Triebwerk Energy dazu!',
  },
  {
  ...
  },
  {
    ...
    title: 'Preis-Leistung',
    description: 'Die Triebwerk Editions bieten nicht nur außergewöhnliche Leistung und Design, sondern auch ein herausragendes Preis-Leistungs-Verhältnis.',
  },
